...
import { setActiveAssistant } from '../../store/slices/assistants'
...
const Sidebar: React.FC = () => {
  ...
  const handleSelectAssistant = (id: string) => {
    dispatch(setActiveAssistant(id))
  }
  ...
  return (
    <div className="w-72 bg-sidebar-bg dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="py-3">
          <div 
            className="flex items-center justify-between px-4 py-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg mx-2 transition-colors duration-200"
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 ${
                      isActive
                        ? 'bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 text-primary shadow-sm'
